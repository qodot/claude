...
## 이 명령어가 하는 일
현재 Git 저장소의 변경사항을 확인하고, 스테이징된 파일이 있으면 커밋을 진행합니다. 스테이징된 파일이 없는 경우, 자동으로 모든 변경사항을 스테이징한 후 커밋을 진행합니다. 커밋 메시지는 사용자가 제공하거나 변경사항을 분석하여 자동으로 생성합니다.
...
### 자동 진행
모든 스테이징 과정은 자동으로 진행되며, 사용자 확인 없이 처리됩니다.
